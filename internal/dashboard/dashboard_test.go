...
func (m *mockStore) IsIgnored(ctx context.Context, repo string, pr int) (bool, error) { return false, nil }
func (m *mockStore) IgnorePR(ctx context.Context, repo string, pr int) error { return nil }
func (m *mockStore) SaveIssues(ctx context.Context, reviewID int64, issues []store.Issue) ([]int64, error) { return nil, nil }
func (m *mockStore) UpdateIssueCommentID(ctx context.Context, issueID int64, commentID int64) error { return nil }
func (m *mockStore) ValidateIssueByCommentID(ctx context.Context, githubCommentID int64, validation string, validatedBy string) error { return nil }
...
func (m *mockStore) UpsertDevMetrics(ctx context.Context, met *store.DeveloperMetrics) error { return nil }
...
func (m *mockStore) UpsertAccess(ctx context.Context, access *store.DashboardAccess) error { return nil }
